...
if __name__ == '__main__':
    ...
    key_dict = {
        ...
        bytes.fromhex(os.environ.get('MIKRO_NPK_SIGN_PUBLIC_KEY') or os.environ.get('MIKRO_NPK_SIGN_PUBLIC_LKEY')):bytes.fromhex(os.environ['CUSTOM_NPK_SIGN_PUBLIC_KEY'])
    }
    if 'MIKRO_CLOUD_PUBLIC_KEY' in os.environ and 'CUSTOM_CLOUD_PUBLIC_KEY' in os.environ:
        key_dict[bytes.fromhex(os.environ['MIKRO_CLOUD_PUBLIC_KEY'])] = bytes.fromhex(os.environ['CUSTOM_CLOUD_PUBLIC_KEY'])
